...
public class TagImageDetailActivity extends FragmentActivity implements
		OnClickListener {
...
//		}
	...
	public class MyOnPageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int position) {
			...
			TagImageDetailFragment.setUrl(photoArray[position]);
	...
	private class ImagePagerAdapter extends FragmentStatePagerAdapter {
		...
		public ImagePagerAdapter(FragmentManager fm, int size) {
			...
			ImageDetailFragment.setUrl(photoArray[0]);
		...
		public Fragment getItem(int position) {
			...
			return TagImageDetailFragment.newInstance(photoArray[position]);
		}
	}
